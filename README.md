# 中小企業向け AI・AIエージェント 社内導入 解説資料

非IT中小企業（100〜500人規模）の**小規模IT部門／社内SE部門**が、
「AI・AIエージェントを、まずIT部門に導入して効果を最大化する」という進め方を
**検討し、判断していく**ための**汎用解説資料**です。特定の自社に向けた提案書ではなく、
同じ課題を持つ読者一般が読んで理解し、自社の状況に当てはめて意思決定に使える資料を
目指しています。**プロジェクト計画ではなく、読んで理解し意思決定に使うための説明資料**
である点が特徴です。

想定読者は二層です。

- **小規模IT部門内**: 技術的な妥当性を仲間内で揃えるための深掘り（実務レベルの理解）。
- **上層（経営層・意思決定者）**: 導入の可否を判断するための、結論・根拠・反論への回答を
  備えた材料。
...
詳細は [research/00-概要.md](research/00-概要.md)。
